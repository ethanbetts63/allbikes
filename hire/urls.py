...
urlpatterns = [
    ...
    path(
        'bookings/<str:booking_reference>/payment-intent/',
        HireCreatePaymentIntentView.as_view(),
        name='hire-create-payment-intent',
    ),
    ...
    path('admin/bookings/<int:pk>/contract/', AdminHireBookingContractView.as_view(), name='admin-hire-booking-contract'),
