...
from pipeline.models.terms_and_conditions import TermsAndConditions
from pipeline.serializers.terms_and_conditions_serializer import TermsAndConditionsSerializer
