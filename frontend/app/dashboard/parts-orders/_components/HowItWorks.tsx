  ...
  return (
    <section className="mt-8 rounded-xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
      ...
      <ol className="mt-3 list-decimal space-y-3 pl-5 text-sm text-slate-600">
        ...
        <li>At checkout, the customer price is Select Portal&apos;s RRP+GST plus our markup and the shipping fee. Our discounted supplier cost and the applied percentages are saved on each order line.</li>
