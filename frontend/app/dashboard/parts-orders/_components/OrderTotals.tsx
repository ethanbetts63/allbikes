    ...
    <div className="mb-6 grid gap-6 sm:grid-cols-2 lg:max-w-2xl">
      ...
      <div className="rounded-md border border-border-light p-3 text-sm">
        ...
        <div className="flex justify-between">
          ...
          <span>${order.margin.customer_parts_total.toFixed(2)}</span>
        </div>
        <div className="flex justify-between">
          <span className="text-[var(--text-dark-secondary)]">Supplier cost</span>
          <span>${order.margin.supplier_parts_total.toFixed(2)}</span>
        </div>
