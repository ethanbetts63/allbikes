...
/** Shown when a payment could not be confirmed within the processing window. */
export default function CheckoutErrorScreen() {
      ...
      <div className="container mx-auto px-4 py-12 max-w-2xl">
        ...
        <div className="bg-[var(--bg-light-primary)] border border-border-light rounded-lg p-6 mb-8 space-y-3 text-sm text-[var(--text-dark-secondary)]">
          <p>
            ...
            <strong className="text-[var(--text-dark-primary)]">check your email</strong> for a confirmation
            message before trying again.
          </p>
          <p>
            If you haven&apos;t received an email within a few minutes, please contact us and quote your
            reference number above and we&apos;ll sort it out.
          </p>
        </div>
