...
/**
 * Waits for the Stripe webhook to confirm the booking.
 *
 * Two entry paths: a card confirmed inline (no client secret in the URL) just
 * polls; a 3DS redirect checks the intent with Stripe first so a declined card
 * goes back to the payment form instead of polling for half a minute.
 */
