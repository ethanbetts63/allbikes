...
import { ArrowRight, CalendarDays, MousePointerClick, KeyRound, ShieldCheck, Clock, Bike, MapPin } from 'lucide-react';
...
const usps = [
    {
        ...
        description: 'Daily, weekly, and monthly rates available. Only pay for the time you need.',
    },
    {
        icon: ShieldCheck,
        title: 'Refundable Bond',
        description: 'A bond is held at time of payment and refunded in full when the bike is returned in good condition.',
    },
    {
        icon: Bike,
        title: 'Maintained Fleet',
        description: 'Every bike in our hire fleet is serviced and maintained by our in-house workshop team.',
    },
    {
        icon: MapPin,
        title: 'Easy Pickup',
        description: 'Collect and return from our workshop in Dianella — Unit 5 / 6 Cleveland Street.',
    },
];
