...
class BookingAdmin(admin.ModelAdmin):
    list_display = ('customer_name', 'bike_name', 'registration', 'drop_off_date', 'drop_off_time', 'status', 'source')
    list_filter = ('status', 'source', 'drop_off_date')
    search_fields = ('customer_name', 'registration', 'bike_name', 'customer_phone', 'customer_email')
